...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email){
        ...
        // test validation for telnum
        // regular expression for extracting number: 0-9
        const reg = /^\d+$/;
        if (this.state.touched.telnum && !reg.test(telnum)) {
            errors.telnum = 'Tel number should only contain number characters'
